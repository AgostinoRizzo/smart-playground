...
import py_tinyos.tinyos.message.Message
...
class SerialPacket(py_tinyos.tinyos.message.Message.Message):
    # Create a new SerialPacket of size 7.
    def __init__(self, data="", addr=None, gid=None, base_offset=0, data_length=7):
        py_tinyos.tinyos.message.Message.Message.__init__(self, data, addr, gid, base_offset, data_length)
